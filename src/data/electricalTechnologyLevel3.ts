export const electricalTechnologyLevel3Questions = [
  {
    id: "et3-001",
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "EAWR are made under the HSW Act, so breaches are enforced via that Act.",
  },
  {
    id: "et3-006",
    ...
    correctIndex: 0,
    explanation:
      "EAWR applies to workplaces and covers systems beyond the usual BS 7671 scope.",
  },
  {
    id: "et3-007",
    ...
    correctIndex: 0,
    explanation:
      "The HSE memorandum of guidance HSR25 provides interpretation guidance for EAWR.",
  },
  {
    id: "et3-008",
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "The On‑Site Guide gives practical guidance for standard installations.",
  },
  {
    id: "et3-017",
    ...
    correctIndex: 0,
    explanation:
      "Technical specifications are a formal source of technical information.",
  },
  {
    id: "et3-018",
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "As‑fitted drawings record what was actually installed on site.",
  },
  {
    id: "et3-024",
  ...
  },
  {
    ...
    options: [
      ...
      "Certifying private wiring",
      "Testing portable appliances",
    ],
    correctIndex: 0,
    explanation:
      "National Grid operates transmission and balances supply with demand.",
  },
  {
    id: "et3-028",
    ...
    correctIndex: 0,
    explanation:
      "Because large‑scale storage is limited, supply must match demand.",
  },
  {
    id: "et3-029",
  ...
  {
    id: "et3-030",
    question: "Why are transmission voltages raised to 275 kV or 400 kV?",
    options: [
    ...
    correctIndex: 0,
    explanation:
      "Higher voltage reduces current for a given power, reducing I²R losses.",
  },
  {
    id: "et3-031",
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "Higher voltages increase arc length, so arcing through air can occur.",
  },
  {
    id: "et3-033",
    ...
    correctIndex: 0,
    explanation:
      "Higher voltages require greater insulation distance to avoid flashover.",
  },
  {
    id: "et3-034",
    ...
    correctIndex: 0,
    explanation:
      "The text notes renewables are an ever‑growing share of UK electricity.",
  },
  {
    id: "et3-035",
    ...
    correctIndex: 0,
    explanation:
      "Off‑peak electricity pumps water up; it is released through turbines at peak times.",
  },
  {
    id: "et3-036",
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "A3 copies are convenient but reductions can make drawings less readable.",
  },
  {
    id: "et3-040",
