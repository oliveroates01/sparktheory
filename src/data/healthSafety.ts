...
export const healthSafetyQuestions: Question[] = [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: "Guidance shows practical ways of meeting legal requirements.",
  },
  {
    id: "hs-009",
    question:
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: "Working at height is a common risk that must be assessed.",
  },
  {
    id: "hs-018",
  ...
  },
  {
    id: "hs-019",
    question:
      "Which is an example of a hazardous substance category mentioned?",
    options: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: "Helmets and harnesses are common methods of protection.",
  },
  {
    id: "hs-025",
    ...
    correctIndex: 0,
    explanation: "Prohibition signs are red circles with a diagonal line.",
  },
  {
    id: "hs-026",
    ...
    correctIndex: 0,
    explanation: "Warning signs are triangular and yellow with black borders.",
  },
  {
    id: "hs-027",
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: "Safe condition signs are green and provide safety guidance.",
  },
  {
    id: "hs-029",
  ...
  },
  {
    id: "hs-033",
    question:
      "In many companies with more than 20 employees, safety is managed by a:",
    options: [
  ...
  },
  {
    id: "hs-034",
    question:
      "What should an employee do first after spotting a dangerous situation?",
    options: [
  ...
  },
  {
    id: "hs-037",
    question:
      "Which supply voltages were harmonised in the UK from 1 January 1995?",
    options: [
  ...
  },
  {
    id: "hs-041",
    question:
      "Under the supply regulations, what can a distributor refuse to do?",
    options: [
  ...
  },
  {
    id: "hs-050",
    question:
      "Why should electricians be 'legally aware' about safety and workmanship?",
    options: [
  ...
  },
  {
    id: "hs-053",
    question:
      "What should you do if you are unsure how to complete a task safely?",
    options: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: "Raising the alarm quickly helps protect everyone on site.",
  },
  {
    id: "hs-066",
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: "A hazard is anything that could cause harm.",
  },
  {
    id: "hs-075",
    legacyIds: ["hs-055"],
    ...
    correctIndex: 0,
    explanation: "Risk is the likelihood that a hazard will cause harm.",
  },
  {
    id: "hs-076",
    legacyIds: ["hs-056"],
  ...
  },
  {
    ...
    options: ["Method statement", "Payslip", "Delivery note", "Tool catalogue"],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: "They provide instructions to complete work safely.",
  },
  {
    id: "hs-080",
    legacyIds: ["hs-060"],
    ...
    correctIndex: 0,
    explanation: "RAMS means Risk Assessment and Method Statement.",
  },
  {
    id: "hs-081",
    legacyIds: ["hs-061"],
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: "Poor housekeeping is a major cause of accidents.",
  },
  {
    id: "hs-083",
    legacyIds: ["hs-063"],
    ...
    correctIndex: 0,
    explanation: "Loose materials and cables create trip hazards.",
  },
  {
    id: "hs-084",
    legacyIds: ["hs-064"],
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: "Harnesses help protect workers when working at height.",
  },
  {
    id: "hs-086",
    legacyIds: ["hs-066"],
    ...
    correctIndex: 0,
    explanation: "Equipment must be checked before use to ensure it is safe.",
  },
  {
    id: "hs-087",
    legacyIds: ["hs-067"],
    ...
    correctIndex: 0,
    explanation: "Damaged tools can cause accidents and must not be used.",
  },
  {
    id: "hs-088",
    legacyIds: ["hs-068"],
    ...
    correctIndex: 0,
    explanation: "You should always seek guidance if unsure.",
  },
  {
    id: "hs-089",
    legacyIds: ["hs-069"],
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "Inspectors can enter premises and investigate without notice.",
  },
  {
    id: "hs-094",
    legacyIds: ["eit-013"],
  ...
  },
  {
    ...
    options: ["Asbestos", "Dusts and fumes", "Chemicals", "Biological agents"],
    correctIndex: 0,
    explanation:
