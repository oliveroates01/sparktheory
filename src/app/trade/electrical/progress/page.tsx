...
import ElectricalProgressClient from "./ElectricalProgressClient";

export default function ElectricalProgressPage() {
  return (
    <Suspense
      fallback={
            ...
            <section className="mx-auto w-full max-w-5xl">
              <div className="mt-6 rounded-2xl bg-[#1F1F1F] p-4 ring-1 ring-[#FF9100]/20 sm:p-6">
                <div className="w-full max-w-[340px] min-w-0 mx-auto sm:max-w-none rounded-3xl bg-white/5 p-6 ring-1 ring-white/10">
                  ...
                  <div className="mt-5 h-[220px] sm:h-[260px] rounded-2xl bg-white/5 ring-1 ring-white/10 animate-pulse" />
                </div>
              </div>
            </section>
          </div>
